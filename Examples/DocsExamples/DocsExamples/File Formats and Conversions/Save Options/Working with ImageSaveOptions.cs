...
namespace DocsExamples.File_Formats_and_Conversions.Save_Options
{
    internal class WorkingWithImageSaveOptions : DocsExamplesBase
    {
        ...
        public void ExposeThresholdControlForTiffBinarization()
        {
            ...
            doc.Save(ArtifactsDir + "WorkingWithImageSaveOptions.ExposeThresholdControlForTiffBinarization.tiff", imageSaveOptions);
        ...
        public void GetTiffPageRange()
        {
            ...
            doc.Save(ArtifactsDir + "WorkingWithImageSaveOptions.GetTiffPageRange.tiff", imageSaveOptions);
        ...
        public void Format1BppIndexed()
        {
            ...
            doc.Save(ArtifactsDir + "WorkingWithImageSaveOptions.Format1BppIndexed.Png", imageSaveOptions);
        ...
        public void GetJpegPageRange()
        {
            ...
            doc.Save(ArtifactsDir + "WorkingWithImageSaveOptions.GetJpegPageRange.jpg", imageSaveOptions);
