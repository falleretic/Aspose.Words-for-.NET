...
namespace DocsExamples.Programming_with_Documents.Document_Content.Helpers
{
        ...
        public class CustomBarcodeGenerator : IBarcodeGenerator
        {
            ...
            public Image GetBarcodeImage(BarcodeParameters parameters)
            {
                ...
                switch (type)
                {
                    ...
                    case "CODE128":
                        ...
                        break;
                    case "CODE39":
                        builder.EncodeType = EncodeTypes.Code39Standard;
                        break;
                    case "EAN8":
                        builder.EncodeType = EncodeTypes.EAN8;
                        break;
                    case "EAN13":
                        builder.EncodeType = EncodeTypes.EAN13;
                        break;
                    case "UPCA":
                        builder.EncodeType = EncodeTypes.UPCA;
                        break;
                    case "UPCE":
                        builder.EncodeType = EncodeTypes.UPCE;
                        break;
                    case "ITF14":
                        builder.EncodeType = EncodeTypes.ITF14;
                        break;
                    case "CASE":
                        builder.EncodeType = EncodeTypes.None;
                        break;
                }

                if (builder.EncodeType.Equals(EncodeTypes.None))
                    return null;

                builder.CodeText = parameters.BarcodeValue;

                if (builder.EncodeType.Equals(EncodeTypes.QR))
            ...
            return builder.BarCodeImage;
                ...
                builder.BarCodeImage.Save(DocsExamplesBase.ArtifactsDir + "GetBarcodeImage.png");
                return Image.Decode(DocsExamplesBase.ArtifactsDir + "OldBarcodeImage.png");
#endif
            }
            ...
            public Image GetOldBarcodeImage(BarcodeParameters parameters)
            {
                ...
                BarCodeBuilder builder = new BarCodeBuilder
                {
                    EncodeType = EncodeTypes.Postnet,
            ...
            return builder.BarCodeImage;
#elif NETCOREAPP2_1 || __MOBILE__
                builder.BarCodeImage.Save(DocsExamplesBase.ArtifactsDir + "OldBarcodeImage.png");
                return Image.Decode(DocsExamplesBase.ArtifactsDir + "OldBarcodeImage.png");
#endif
            }
