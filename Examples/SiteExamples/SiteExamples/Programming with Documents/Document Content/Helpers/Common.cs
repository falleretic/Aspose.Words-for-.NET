...
namespace SiteExamples.Programming_with_Documents.Document_Content.Helpers
{
    internal class Common
    {
        ...
        public static ArrayList ExtractContent(Node startNode, Node endNode, bool isInclusive)
        {
            ...
            while (isExtracting)
            {
                ...
                // Move to the next node and extract it
                // If next node is null that means the rest of the content is found in a different section
        ...
        {
            // Test if the node is desendant of a Paragraph or Table node and also is not a paragraph
            // or a table a paragraph inside a comment class which is decesant of a pararaph is possible
