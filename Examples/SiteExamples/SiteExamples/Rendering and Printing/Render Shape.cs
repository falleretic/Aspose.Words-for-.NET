...
namespace SiteExamples.Rendering_and_Printing
{
    class RenderShape : SiteExamplesBase
    {
        [Test]
        public void RenderShapeToDisk()
        {
            ...
            r.Save(ArtifactsDir + "RenderShapeToDisk.emf", imageOptions);
        ...
        public void RenderShapeToGraphics()
        {
            ...
            using (Bitmap image = new Bitmap((int) (maxSide * 1.25), (int) (maxSide * 1.25)))
            {
                ...
                image.Save(ArtifactsDir + "RenderShapeToGraphics.png", ImageFormat.Png);
            }
        }
