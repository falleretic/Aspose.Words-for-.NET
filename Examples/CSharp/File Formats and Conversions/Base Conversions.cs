...
namespace Aspose.Words.Examples.CSharp.File_Formats_and_Conversions
{
    class BaseConversions : TestDataHelper
    {
        ...
        public static void TxtToDocx()
        {
            ...
            Document doc = new Document(MyDir + "Txt document.txt");
        ...
        {
            //ExStart:ImageToPdf
            ConvertImageToPdf(MyDir + "Test.jpg", ArtifactsDir + "BaseConversions.JpgToPdf.pdf");
            ConvertImageToPdf(MyDir + "Test.png", ArtifactsDir + "BaseConversions.PngToPdf.pdf");
            ConvertImageToPdf(MyDir + "Test.wmf", ArtifactsDir + "BaseConversions.WmfToPdf.pdf");
            ConvertImageToPdf(MyDir + "Test.tiff", ArtifactsDir + "BaseConversions.TiffToPdf.pdf");
            ConvertImageToPdf(MyDir + "Test.gif", ArtifactsDir + "BaseConversions.GifToPdf.pdf");
            //ExEnd:ImageToPdf
        }
